        ...
        >
            ...
            >
                ...
                <div className="relative w-full mb-3">
                    <input placeholder="Username" value={username} onChange={e => setUsername(e.target.value)} className="border-none bg-[#F2F1F3] w-full h-[44px] px-[14px] pr-[44px] rounded-[10px] text-[14px] outline-none text-gray-900" />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500"><UserIcon /></div>
                </div>
                <div className="relative w-full mb-3">
                    <input placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} className="border-none bg-[#F2F1F3] w-full h-[44px] px-[14px] pr-[44px] rounded-[10px] text-[14px] outline-none text-gray-900" />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500"><MailIcon /></div>
                </div>
                <div className="relative w-full mb-4">
                    <input placeholder="Password" type="password" value={password} onChange={e => setPassword(e.target.value)} className="border-none bg-[#F2F1F3] w-full h-[44px] px-[14px] pr-[44px] rounded-[10px] text-[14px] outline-none text-gray-900" />
            ...
            >
                ...
                <div className="relative w-full mb-3">
                    <input placeholder="Email" value={loginEmail} onChange={e => setLoginEmail(e.target.value)} className="border-none bg-[#F2F1F3] w-full h-[44px] px-[14px] pr-[44px] rounded-[10px] text-[14px] outline-none text-gray-900" />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500"><UserIcon /></div>
                </div>
                <div className="relative w-full mb-2">
                    <input placeholder="Password" type="password" value={loginPassword} onChange={e => setLoginPassword(e.target.value)} className="border-none bg-[#F2F1F3] w-full h-[44px] px-[14px] pr-[44px] rounded-[10px] text-[14px] outline-none text-gray-900" />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500"><LockIcon /></div>
                </div>
